...
namespace UnityEngine.UI.Extensions
{
    ...
    public class VerticalScrollSnap : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler
    {
        ...
        {
            int _offset = -(int)((_screensContainer.transform.childCount)*gameObject.GetComponent<RectTransform>().rect.height/2);
            int _step = (int)gameObject.GetComponent<RectTransform>().rect.height;
            float _dimension = 0;
        ...
        public delegate void OnSelectionChangedDelegate(int curScreen);
